...
public class AppTest 
{
    ...
    {
        ExtentSparkReporter spark=new ExtentSparkReporter("D:\\selenium\\ModelLab\\AbhiBus\\ple.html");
    ...
    {  
        ...
        String path="D:\\selenium\\ModelLab\\AbhiBus\\ss.png";
    ...
    {  
        ...
        File ss=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String path="D:\\selenium\\ModelLab\\AbhiBus\\ss1.png";
        FileUtils.copyFile(ss,new File(path));
    ...
    public void AfterMethod(ITestResult result) throws IOException
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
          ...
          File ss=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
          String path="D:\\selenium\\EX(abhi)\\EX(abhi)\\lab\\"+result.getName()+".png";
          FileUtils.copyFile(ss,new File(path));
